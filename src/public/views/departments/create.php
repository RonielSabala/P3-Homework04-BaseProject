<div class="container center-screen pt-2 mb-3">
    <div class="card shadow-sm entity-card w-100" style="max-width: 1000px;">
        ...
        <div class="card-body">
            <h5 class="text-secondary mb-3">Complete the form below</h5>
            <hr>
            ...
            <form method="post">
                <div class="edit-grid">
                    <div class="edit-item">
                        ...
                        <input type="text" id="dept_name" name="dept_name" class="form-control" placeholder="Enter a department name" required>
                    </div>
                    <div class="edit-item">
                        <label for="faculty_head" class="form-label">Faculty Head</label>
                        <input type="text" id="faculty_head" name="faculty_head" class="form-control" placeholder="Enter a faculty head" required>
                    </div>
                    <div class="edit-item">
                        <label for="email" class="form-label">Email</label>
                        <input type="email" id="email" name="email" class="form-control" placeholder="Enter an email" required>
                    </div>
                </div>
