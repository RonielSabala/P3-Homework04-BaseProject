    ...
    public static function showAlert(
        ...
        <div class='text-center'>
            <div class='alert alert-$type'>
                <i class='bi " . ($type === 'success' ? 'bi-check-circle-fill' : ($type === 'danger' ? 'bi-exclamation-triangle-fill' : 'bi-info-circle-fill')) . " me-2'>
                </i>
                $message
            </div>";
        if ($showReturn) {
            echo "<a href='$returnRoute' class='btn btn-primary mt-2'>Volver</a>";
        }
        echo "</div>";
    }
